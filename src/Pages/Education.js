                ...
                <div className="educationblock">
                  <div className="row">
                    <div className="col-sm-4">
                      <h5 data-aos="fade-right">Oct, 2023 - Nov, 2023</h5>
                    </div>
                    <div className="col-sm-8">
                      <div className="educationright" data-aos="fade-left">
                        <h5>JamTech Technologies Pvt. Ltd.</h5>
                        <h6>React Developer Intern</h6>
                        <h6>
                          - HTML, CSS, Bootstrap, Javascript, jQuery,ReactJs,NodeJs,Redux
                          <br />
                        ...
                        <div className="col-sm-4">
                      <h5 data-aos="fade-right">Aug, 2023 - Nov, 2023</h5>
                    </div>
                    <div className="col-sm-8">
                      <div className="educationright" data-aos="fade-left">
                        <h5>Ethnus</h5>
                        <h6>MERN Stack Intern</h6>
                        <h6>
                          - HTML, CSS, Bootstrap, Javascript, jQuery,ReactJs,NodeJs,Redux,MongoDB,Express,React,Node
                          <br />
